...
public final class Energy extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Energy";


  private Energy() {}
  private static int hashCode = hashFunction();
  private static Energy gomProto = (Energy) factory.build(new Energy());
  
  /**
   * Constructor that builds a term rooted by Energy
   *
   * @return a term rooted by Energy
   */

  public static Energy make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Energy and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
   ...
   //Instrucao interface
  /**
   * Returns true if the term is rooted by the symbol Energy
   *
   * @return true, because this is rooted by Energy
   */
  @Override
